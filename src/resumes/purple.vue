<template>
<div class="resume" v-if="person" id="template">
    <div id="resume-header">
        <div id="header-left">
            ...
            <div id="info-flex">
                ...
                <span v-if="person.contact.github" id="github"><a :href='contactLinks.github'><i class="fab fa-github" aria-hidden="true"></i> {{person.contact.github}}</a></span>
            </div>
        </div>
        <div id="header-right">
            <div id="headshot"></div>
